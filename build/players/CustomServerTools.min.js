...
var player = this.data.players[p];
	...
	if(typeof(listenToDisabled) == typeof(undefined)) { listenToDisabled = true; }
		///String player
		///IScoreboard sb
		///IData data
...
function getDiskHandler(diskname) {
	if(typeof(diskname) == typeof(undefined)) { diskname = null; }
...
function CSTData(disk, create) {
	if(typeof(disk) == typeof(undefined)) { disk = null; }
	if(typeof(create) == typeof(undefined)) { create = false; }
...
function Collection(o) {
	if(typeof(o) == typeof(undefined)) { o = []; }
    this.items = o;
...
function tellPlayerTitle(player, rawtext, type, target) {
	if(typeof(type) == typeof(undefined)) { type = "actionbar"; }
...
function CustomMenuItem(id, damage, count) {
	if(typeof(damage) == typeof(undefined)) { damage = 0; }
