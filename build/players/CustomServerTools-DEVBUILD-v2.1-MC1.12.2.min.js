...
function DataHandler(type, name) {
	if(PluginAPI.DataHandlers.implementFuncs[type]) {
		PluginAPI.DataHandlers.implementFuncs[type].apply(this, [type, name]);
	}
	this.type = type;
	this.name = name;
	this.data = this.data || {};
...
var SCRIPT_VERSION = "CustomServerTools-DEVBUILD-v2.1-MC1.12.2.min.js";
